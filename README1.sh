...
echo "${ORANGE_TEXT}${BOLD_TEXT}           WELCOME TO bhoomika R GUIDE${RESET_FORMAT}"
...
echo "${ORANGE_TEXT}${BOLD_TEXT}=======================================================${RESET_FORMAT}"
echo
echo "${RED_TEXT}${BOLD_TEXT}${UNDERLINE_TEXT}https://www.youtube.com/@bhoomika R${RESET_FORMAT}"
